...
import com.sri.util.DownloadImageTask;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispTxt = (TextView) findViewById(R.id.fullTxt);

        dispTxt.setText("Full Info Message from Srivatsan's Beacon");
    ...
    public void displayTableRow(final ProximityKitBeacon beacon, final String displayString, final boolean updateIfExists) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                imageTask.execute(beacon.getAttributes().get("postImgURL"));
    ...
    public void toggleManager(View view) {
        if (view.getId() != R.id.manager_toggle) {
            return;
        }
